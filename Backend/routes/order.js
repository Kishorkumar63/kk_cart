...
router
  .route("/orders")
  .get(isAuthenticatedUser, authorizeRoles("admin"), orders); //orders
router
  .route("/orders/:id")
  .put(isAuthenticatedUser, authorizeRoles("admin"), updateOrder); //updateOrder
router
  .route("/delete/:id")
  .put(isAuthenticatedUser, authorizeRoles("admin"), deleteOrder); //deleteOrder
